...
public class WeaponTrail : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _meshTrail;  
    [SerializeField] private int _meshTrailFrames;  
    ...
    {
        _mesh = new Mesh();
        _meshTrail.GetComponent<MeshFilter>().mesh = _mesh;

        _vertices = new Vector3[_meshTrailFrames * NUM_VERTICES];
    ...
    {
        if(_frameCount == (_meshTrailFrames * NUM_VERTICES))
            _frameCount = 0;
